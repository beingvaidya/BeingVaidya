...
public class SavedPostsAdapter extends RecyclerView.Adapter<SavedPostsAdapter.ViewHolder> {
    Context context;
    public List<FeedModel> fList;
    ProgressUtils progressUtils;
    UnSaveCalled listner;

    public SavedPostsAdapter(Context context, List<FeedModel> fList , UnSaveCalled callback) {
...
//                        unsavePost(feedModel.DocId, position);
                        listner.onUnsave(feedModel.DocId ,position );
                        dialog.dismiss();
                    }
...
//            iv_feed = itemView.findViewById(R.id.iv_feed);
            ...
            tv_unsave.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showRemoveDialog(fList.get(getLayoutPosition()), getLayoutPosition());
                }
            });
